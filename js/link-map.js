var myChart;
var testChart;
var domMain = document.getElementById('deploy-china');
var testArea = document.getElementById('deploy-local');
...
function refresh(){
    ...
    testChart = echarts.init(testArea);
//    window.onresize = myChart.resize;
    var option = {
        tooltip : {
            trigger: 'item'
    ...
    myChart.on(ecConfig.EVENT.MAP_SELECTED, function (param){
        ...
        //myChart.setOption(option, true);
        testChart.setOption(option1, true);
    });
